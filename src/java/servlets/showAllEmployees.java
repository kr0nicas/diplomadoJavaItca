...
public class showAllEmployees extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Query result = em.createNamedQuery("Employees.findAll");
           java.util.List employeeList =   result.getResultList();
           for (int i = 0; i < employeeList.size(); i++){
           out.println(((Employees)employeeList.get(i)).getFirstName()+" "+((Employees)employeeList.get(i)).getLastName() +"<br>");
           }
            em.close();
        } finally {            
            out.close();
